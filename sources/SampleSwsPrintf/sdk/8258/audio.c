...
void audio_dmic_init(AudioRate_Typedef Audio_Rate)
{
	...
	reg_dfifo_ain = 	  MASK_VAL( FLD_AUD_DMIC0_DATA_IN_RISING_EDGE,	AUDIO_DMIC_DATA_IN_RISING_EDGE,\
									...
									FLD_AUD_INPUT_MONO_MODE, 			((DMIC_INPUT_MODE_STEREO==1)?0:1), \
									FLD_AUD_DECIMATION_FILTER_BYPASS, 	0, \
...
unsigned char I2S_To_HPout_CMD_TAB[7][2] ={	{WM8731_RESET_CTRL, 				0x00},
											{WM8731_ANA_AUDIO_PATH_CTRL,		0x12},//or 0x12
											{WM8731_DIG_AUDIO_PATH_CTRL,		0x00},
											{WM8731_POWER_DOWN_CTRL,			0x21},//or 0x07
...
#if(AUDIO_CODEC_TO_CODEC==1)
unsigned char LineIn_To_I2S_CMD_TAB[9][2]={	{WM8731_RESET_CTRL, 				0x00},
											{WM8731_LEFT_IN,					0x17},//0x7:LINMUTE
											{WM8731_RIGHT_IN,					0x17},//0x7:RINMUTE
											{WM8731_ANA_AUDIO_PATH_CTRL,		0x12},//0x02  //0:MICBOOST; 1:MUTEMIC; 2:INSEL MIC; 3:BYPASS; 4:DACSEL
											{WM8731_DIG_AUDIO_PATH_CTRL,		0x00},//0x09  //if bit3=1:DACMUTE.  //dig audio path ctrl
											{WM8731_POWER_DOWN_CTRL,			0x22},//0x0a //0:LINEINPD; 1:MICPD; 2:ADCPD; 3:DACPD; 4:OUTPD; 5:OSCPD; 6:CLKOUTPD; 7:POWEROFF
											{WM8731_DIG_AUDIO_INTERFACE_FORMAT,	0x02},
											{WM8731_SAMPLING_CTRL,				0x01},//0x18 original//0:USB MODE; 1:BOSR; 2:SR; 6:CLKDIV2; 7:CLKODIV2;    bit[5:2] SR:6--->32KHz SR:0--->48KHz
											{WM8731_ACTIVE_CTRL,				0x01},
};
#else
unsigned char LineIn_To_I2S_CMD_TAB[9][2]={	{WM8731_RESET_CTRL, 				0x00},

...
def main():
	...
	sec_start = [b"__start",b"_start_text_", b"_start_rodata_",b"_retention_data_start_",b"_ramcode_size_",b"_ictag_start_",b"_ictag_end_", b"_start_data_", b"_start_bss_", b"irq_stk",  b"_end_bss_",	 b"__start"]
	sec_end   = [b"_ramcode_size_",   b"_end_text_",  b"_end_rodata_", b"_retention_data_end_",  b"_ictag_start_",    b"_ictag_end_",  b"_ictag_end_",  b"_end_data_",   b"_end_bss_",  b"IRQ_STK_SIZE", b"__SRAM_SIZE", b"_bin_size_"]
	sec_start_add = [0, 0, 0, 0, SRAM_BASE_ADDR, 0, 0, 0, 0, 0, 0, 0]
	sec_end_add =   [0, 0, 0, 0, 0, 0, 0x800, 0, 0, 0, SRAM_BASE_ADDR, 0]
	sec_size = []

	e = ELFFile(args.elffname, args.tools);
	chip_sram_size = e.get_symbol_addr(b"__SRAM_SIZE");
	...
	if e.get_symbol_addr(b"IRQ_STK_SIZE"):
		sec_start_add[8] = e.get_symbol_addr(b"IRQ_STK_SIZE")
	load_sram = e.get_symbol_addr(b"_ramcode_size_div_16_align_256_") << 4;
	if load_sram == 0:
		load_sram = e.get_symbol_addr(b"_bin_size_div_16") << 4;
	ictag = e.get_symbol_addr(b"_ramcode_size_align_256_"); #_ramcode_size_div_256_ << 8
	print("===================================================================")

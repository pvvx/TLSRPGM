 ...
 *****************************************************/
/* Memory SPI data access */
#define reg_master_spi_data		REG_ADDR8(0x0c)
/*
[0]: p_mcsn
[1]: rsvd
[2]: continuous mode
[3]: 1 for read command; 0 for write command
[4]: address auto increase */
...
/* Memory SPI read command ID
#define reg_master_spi_id		REG_ADDR8(0x0e)
[0]: dual data mode
[1]: dual address mode
[7:2]: MSPI clock speed
#define reg_master_spi_mode		REG_ADDR8(0x0f) */
...
#define reg_rst_clk			REG_ADDR32(0x60)
enum{
	FLD_RST_SPI = 				BIT(0),
	FLD_RST_I2C = 				BIT(1),
	FLD_RST_USB = 				BIT(2),
	...
	FLD_RST_RISC =				BIT(20),
	FLD_RST_MCIC = 				BIT(21),
	FLD_RST_RISC1 =				BIT(22),
	FLD_RST_MCIC1 = 			BIT(23),

	FLD_CLK_SPI_EN = 			BIT(24),
	FLD_CLK_I2C_EN = 			BIT(25),
	FLD_CLK_UART_EN = 			BIT(26),
	FLD_CLK_USB_EN = 			BIT(27),
	FLD_CLK_PWM_EN = 			BIT(28),
	FLD_CLK_QDEC_EN = 			BIT(29),

	FLD_CLK_SWIRE_EN = 			BIT(31),
};

#define reg_clk_en				REG_ADDR16(0x64)
enum{
	FLD_CLK_ZB_EN = 			BIT(0),
	FLD_CLK_SYS_TIMER_EN = 		BIT(1),
	FLD_CLK_DMA_EN = 			BIT(2),
	FLD_CLK_ALGM_EN = 			BIT(3),
	FLD_CLK_AES_EN = 			BIT(4),

	FLD_CLK_AIF_EN = 			BIT(8),
	FLD_CLK_AUD_EN = 			BIT(9),
	FLD_CLK_DFIFO_EN = 			BIT(10),
	FLD_CLK_MC_EN = 			BIT(12),
	FLD_CLK_MCIC_EN = 			BIT(13),
};
...
#define reg_uart_ctrl			REG_ADDR8(0x96)
enum{
	FLD_UART_CTRL0_BPWC = 			BIT_RNG(0,3),
...
enum{
	FLD_UART__TIMEOUT_BW		 = 	BIT_RNG(0,7),
};

#define reg_uart_rx_timeout1    REG_ADDR8(0x9b)
enum{
	FLD_UART__TIMEOUT_MUL	 = 	BIT_RNG(0,1),
	FLD_UART__P7816_EN	 	 =  BIT(5),
	FLD_UART__MASK_TXDONE_IRQ =  BIT(6),
	FLD_UART__MASK_ERR_IRQ 	 =  BIT(7),
};
...
#define reg_gpio_config_func(i)		REG_ADDR8(0x5a8 +((i>>8)<<1) + ((i&0xf0)?1:0))	  //5a8..5af

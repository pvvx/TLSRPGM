...
[2]: master received status: 0 for ACK; 1 for NAK
 */
...
/* [6:0] I2C read address */
//#define reg_host_map_status	 REG_ADDR8(0x20)
/*
[0]: host_rd_clear_en
[1]: host_cmd_irq_o: i2c host operation have happened
...
[2]: write 1 clear host_rd_tag_stat
...
/* ADC auto channel 0 (Misc) period */
...
/* Period = ADCMAXLR * 16 system clocks */
...
[5:4]: audio ADC mode
	00: no audio; 01: mono; others: reserved
...
/* I2C Mapping mode buffer address */
...
enum{
	CLK_SEL_RC32M = 0,	// 32M clock from RC
	CLK_SEL_HSDIV = 1,	// hs divider clk (0x66[4:0])
	CLK_SEL_PADM = 2,	// 12M/16M clock from pad (Crystal Oscillator)
	CLK_SEL_PADK = 3	// Crystal Oscillator Pad 32.768KHz
};
...
enum{
	...
	FHS_SEL_RC = 1,		// 32M clock from osc
	FHS_SEL_PAD = 2		// 12M/16M clock from pad (quartz)
};
/****************************************************
  OTP  addr : 0x71
 *****************************************************/
 ...
 * 		1: 32k pad
 * [1] dmic clock select,
 * 		1: select 32k (refer to bit[0] to decide which 32k ;
 * 		0: dmic clk div
 * [2] usb phy clock select,
 * 		1 : 192M divider
 * 		0: 48M pll
 * [7:4] r_lpr_div, decide system clock speed in low power mode
 */
#define reg_clk_mux_cel			REG_ADDR8(0x73) // After reset [0x73] = 0x14
...
#define reg_tmr_ctrl16			REG_ADDR16(0x620)		// ��Ϊ0x622 ��Ҫд
...
#define reg_irq_mask1			REG_ADDR8(0x640)
#define reg_irq_mask2			REG_ADDR8(0x641)
#define reg_irq_mask3			REG_ADDR8(0x642)
#define reg_irq_mask4			REG_ADDR8(0x643)

#define reg_irq_pri				REG_ADDR32(0x644)
#define reg_irq_src				REG_ADDR32(0x648)
#define reg_irq_src1			REG_ADDR8(0x648)  //  After reset [0x648] = 0x00000000
#define reg_irq_src2			REG_ADDR8(0x649)
...
[1]: audio input select
	0: D-MIC; 1: ADC
[2]: bypass input
[3]: disable D-MIC channel
[4]: dfifo enable
[5]: wptr enable
[6]: wptr clear
 */
...
[6:4]: Decimation shift select (0 ~ 5)
 */
...
[3:0]: HPF shift
[4]: bypass HPF
	1: bypass HPF, 0: use HPF
[5]: bypass ALC
	1: bypass ALC, 0: use ALC
[6]: bypass LPF
	1: bypass LPF, 0: use LPF
 */
...
#endif // #if MCU_CORE_TYPE == MCU_CORE_8266
